    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-8 col-md-12 col-sm-12 col-12">
                <form:form action="/NJProjekatFED/goods_received_note/update_goods_received_note_item/${rbr}" method="post" modelAttribute="stavka">
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <a href="<c:url value='/goods_received_note/remove_goods_received_note_item_l/${rbr}'/>" class="btn btn-primary"><i class="fa fa-remove"></i></a>
                        </div>
                    </div>
                </form:form>
            </div>

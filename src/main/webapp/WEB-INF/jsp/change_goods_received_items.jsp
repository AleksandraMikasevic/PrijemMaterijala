                    ...
                    <tbody id="stavke">
                        <c:forEach items="${grcn.stavkaprijemniceCollection}" var="item">
                            <tr>
                                ...
                                <td><a href="/NJProjekatFED/goods_received_note/change_goods_received_note_item_info/${item.stavkaprijemnicePK.redniBroj}" class="btn btn-primary"><i class="fa fa-cogs"></i></a></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
